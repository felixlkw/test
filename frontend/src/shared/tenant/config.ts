...
const GS_CONSTRUCTION: TenantConfig = {
  ...
  ehsRecommendedQuestions: {
    // 건설 — 토목/건축 일반(아파트·고층·도로·교량·기초·플랜트). 반도체 팹 시공
    // 특화 질문(LG이노텍)은 GS 일반 건설에 부적합하여 재사용하지 않고, 건설업
    // 중대재해 다발 유형(추락·붕괴·협착·질식·감전·화재) 중심으로 신규 작성.
    construction: [
      "5m 이상 굴착 사면의 안전 기울기와 흙막이 가시설 계측관리(변위·하중) 기준은 어떻게 잡아야 해?",
      "거푸집 동바리 콘크리트 타설 중 붕괴를 막으려면 동바리 설치 간격과 검사 기준을 어떻게 정해야 해?",
      "시스템비계 조립·해체 시 작업발판과 안전난간 설치 기준, 벽이음 간격은 어떻게 돼?",
      "슬래브 개구부와 단부 추락을 막기 위한 덮개 강도와 안전난간 설치 표준은 어떻게 정해?",
      "타워크레인 인양 작업 시 신호수 배치와 인양물 낙하·충돌 방지, 정격하중 초과 통제는 어떻게 해?",
      "맨홀·정화조·집수정 같은 밀폐공간 진입 전 산소·유해가스 측정과 환기·감시인 배치 절차는?",
      "굴착기(백호) 작업 반경 내 협착·충돌을 막기 위한 유도자 배치와 출입통제 기준은 어떻게 정해?",
      "콘크리트 펌프카 아웃트리거 전도를 막으려면 지반 지지력과 받침판 기준을 어떻게 봐야 해?",
      "동절기 콘크리트 양생 시 갈탄·열풍기 사용으로 인한 일산화탄소 질식을 어떻게 예방해?",
      "가설전기 분전반과 이동전선 감전을 막기 위한 누전차단기·접지·외함 점검 기준은?",
      "철골·데크플레이트 위 고소작업의 안전대 부착설비와 추락방호망 설치 기준은 어떻게 돼?",
      "용접·그라인더 화기작업 시 불티 비산 화재를 막으려면 방화포·소화기·화재감시자 배치를 어떻게 해?",
    ],
  },
};
